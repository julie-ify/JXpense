...
RSpec.describe Product, type: :model do
  ...
  describe 'Validations' do
    ...
    category = Category.create(name: 'Cakes', icon: 'https://www.pselaw.com/wp-content/uploads/2016/08/istockpikachu-160x160.jpg', user_id: user.id)
    ...
    it 'product user should be present' do
      ...
      category = Category.create(name: 'Ice cream', icon: 'https://www.pselaw.com/wp-content/uploads/2016/08/istockpikachu-160x160.jpg', user_id: julie.id)
