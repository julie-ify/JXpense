...
RSpec.describe Product, type: :model do
  describe 'Validations' do
    ...
    product = Product.new(name: 'Cup cake', amount: 100.0, author_id: user.id, category_id: category.id,
                          description: 'lorem ipsum jifhdye hajuosid')
    ...
    it 'product user should be present' do
      ...
      product2 = Product.new(name: 'Cream', amount: 100.0, author_id: julie.id, category_id: category.id,
                             description: 'lorem ipsum jifhdye hajuosid')
